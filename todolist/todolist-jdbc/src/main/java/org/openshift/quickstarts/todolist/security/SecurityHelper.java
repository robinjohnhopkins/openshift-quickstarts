...
public class SecurityHelper {
    ...
    private final static HashMap<String, SSLSocketFactory> socketFactoryStore = new HashMap<>();

    public static void main(String args[]) {
        System.out.println( "SecurityHelper");
    }
    public synchronized static SSLSocketFactory getCreateSocketFactory(
            final String caCertificateFileName,
            final String clientCertificateFileName,
            final String clientKeyFileName) throws Exception
    {
        String key = caCertificateFileName+clientCertificateFileName+clientKeyFileName;
        SSLSocketFactory sslSocketFactory = socketFactoryStore.get(key);
        if (sslSocketFactory == null){
            sslSocketFactory = createSocketFactory(caCertificateFileName, clientCertificateFileName, clientKeyFileName);
            socketFactoryStore.put(key, sslSocketFactory);
        }
